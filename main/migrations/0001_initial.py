    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='main.usertype')),
            ],
            options={
                'ordering': ['first_name', 'middle_name', 'last_name'],
                'permissions': (('can_view_customer', 'Можно просматривать информацию о клиентах'),),
            },
            managers=[
